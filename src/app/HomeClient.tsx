...
export default function HomeClient({ posts, profile }: HomeClientProps) {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-2 md:p-8">
      <div className="mx-auto w-full max-w-[1200px]">
        {/* 최신 게시글 & GitHub 프로필 섹션 */}
        <div className="flex gap-4 sm:gap-6 lg:gap-8 mt-6 sm:mt-10 flex-col lg:flex-row items-stretch mb-6 sm:mb-8">
          {/* 최신 게시글 */}
          <section className="flex-1 w-full flex flex-col">
            ...
            {latestPost && (
              <Link
                ...
                className="bg-white rounded-lg sm:rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow flex-1"
              >
                <div className="relative h-48 sm:h-56 md:h-64 bg-gradient-to-br from-purple-500 to-blue-500">
                  ...
                  <div className="absolute top-3 sm:top-4 left-3 sm:left-4">
                    <span className="bg-white border border-purple-600 text-purple-600 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs font-semibold">
                      최신 게시글
                    </span>
                  </div>
                </div>
                <div className="p-4 sm:p-5 md:p-6">
                  <div className="flex items-center gap-2 mb-2 sm:mb-3">
                    <span className="text-xs sm:text-sm bg-purple-100 text-purple-700 px-2 sm:px-3 py-1 rounded">
                      {latestPost.category}
                    </span>
                  </div>
          ...
          {/* GitHub 프로필 & 잔디 */}
          <section className="flex-1 w-full flex flex-col">
            <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 md:p-6 flex-1">
              {profile && (
                <>
                  <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                    <Image
                      ...
                      width={50}
                      height={50}
                      className="sm:w-[60px] sm:h-[60px] rounded-full border-2 sm:border-4 border-purple-200"
                      unoptimized
                    />
                    <div>
                  ...
                  <div className="border-t pt-4 sm:pt-5">
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                      ...
                      <div className="flex items-center gap-1 sm:gap-2">
                        ...
                        <span className="text-xs sm:text-sm font-medium text-gray-700 min-w-[80px] sm:min-w-[90px] text-center">
                    ...
                    <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg p-3 sm:p-4 md:p-5 border border-gray-200">
                      {/* 요일 헤더 */}
                      <div className="flex gap-1 sm:gap-2 mb-2 sm:mb-3 justify-center">
                        {["일", "월", "화", "수", "목", "금", "토"].map(
                          (day, idx) => (
                            <div key={idx} className="w-8 sm:w-10 text-center">
                            ...
                            {week.map((day, dayIdx) => {
                              ...
                              return (
                                <div
                                  ...
                                  className={`w-8 h-8 sm:w-10 sm:h-10 rounded-md sm:rounded-lg transition-all hover:scale-110 hover:shadow-lg cursor-pointer flex items-center justify-center
                                    ${
                                      day.count > 0
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-4 sm:mt-5 pt-3 sm:pt-4 border-t border-gray-200 gap-2 sm:gap-0">
                        <span className="text-[10px] sm:text-xs font-medium text-gray-500">
                          이번 달 총{" "}
                          {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-2">
          {filteredPosts.map((post) => (
            <Link
              ...
              className="group border rounded-lg sm:rounded-xl shadow-md hover:shadow-lg transition-all overflow-hidden "
            >
              ...
              <div className="p-4 sm:p-5">
                ...
                <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-2 group-hover:text-purple-600 transition-colors line-clamp-2 min-h-[3rem] sm:min-h-[3.5rem]">
                  {post.title}
                </h3>
